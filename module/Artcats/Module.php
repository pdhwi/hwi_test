...
use Zend\Mvc\MvcEvent;
 ...
 use Artcats\Model\Artcat;
 use Artcats\Model\ArtcatTable;
...
class Module
{
    ...
    public function getAutoloaderConfig()
    {
     ...
     public function getServiceConfig()
     {
         return array(
             'factories' => array(
                 'Artcats\Model\ArtcatTable' =>  function($sm) {
                 ...
                 'ArtcatTableGateway' => function ($sm) {
                     ...
                     return new TableGateway('artcat', $dbAdapter, null, $resultSetPrototype);
                 },
             ),
         );
     }
